...
class RestManager {
    ...
    var httpBodyParameters = RestBody()
    var httpBody: Data?
    ...
    private func getHttpBody() -> Data? {
        ...
        if contentType.contains("application/json") {
            let data =  try? JSONSerialization.data(withJSONObject: httpBodyParameters.allValues(), options: [.prettyPrinted, .sortedKeys])
            return data
        } else {
            return httpBody
        }
